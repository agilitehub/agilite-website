  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'glow': {
          '0%, 100%': {
            'box-shadow': '0 0 50px rgba(227, 6, 19, 0.4), 0 0 100px rgba(227, 6, 19, 0.2), 0 0 150px rgba(227, 6, 19, 0.1)',
            'transform': 'scale(1)'
          },
          '50%': {
            'box-shadow': '0 0 70px rgba(227, 6, 19, 0.5), 0 0 120px rgba(227, 6, 19, 0.3), 0 0 180px rgba(227, 6, 19, 0.2)',
