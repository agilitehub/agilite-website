...
import { faCodeBranch, faBug, faPlus, faWrench, faShieldAlt } from '@fortawesome/free-solid-svg-icons'
          ...
          {changes.map((change, index) => (
            <div key={index} className='flex items-start'>
              <div className='w-6 h-6 rounded-full bg-agilite-red/10 dark:bg-agilite-red/20 flex items-center justify-center mr-3 mt-1'>
                <FontAwesomeIcon icon={getIcon(change.type)} className='text-agilite-red text-sm' />
              </div>
              <div>
                <h4 className='font-semibold text-gray-800 dark:text-white mb-1'>{change.title}</h4>
      ...
      changes: [
        {
          ...
          description:
            'Introducing our Business Process Management module for workflow automation and process optimization.'
        },
        {
          type: 'improvement',
      ...
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
            Stay up to date with the latest improvements, features, and fixes in Agilit
