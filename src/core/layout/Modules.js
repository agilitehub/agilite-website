    ...
    <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 overflow-hidden relative group'>
      ...
      <div className='relative'>
        <div className='w-16 h-16 rounded-xl bg-gradient-to-br from-agilite-red to-agilite-red/60 dark:from-agilite-red/20 dark:to-agilite-black flex items-center justify-center mb-6 shadow-lg'>
          <FontAwesomeIcon icon={icon} className='text-xl text-white dark:text-agilite-red' />
        </div>

        <h3 className='text-xl font-bold text-gray-800 dark:text-white mb-4 group-hover:text-agilite-red transition-colors duration-300'>
          {title}
        </h3>
...
const Modules = () => {
  const modules = [
    ...
    },
    {
      ...
      features: ['JSON to Excel mapping', 'Excel to JSON mapping', 'JSON to JSON mapping', 'Custom mapping rules']
    },
    {
      icon: faFileCode,
      title: 'Templates Module',
      description: 'Create and manage reusable document and message templates.',
      features: ['Template creation and editing', 'Variable substitution', 'Template versioning', 'Template validation']
    },
    {
      icon: faUserShield,
      title: 'Roles Module',
      description: 'Manage user roles and permissions across your system.',
      features: ['Role-based access control', 'Permission management', 'User role assignment', 'Access auditing']
    },
    {
      icon: faDiagramProject,
      title: 'BPM Module',
      description: 'Design and execute business process management workflows.',
      features: ['Workflow design', 'Process automation', 'Task management', 'Process monitoring']
    }
  ]
      ...
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16'>
          <h2 className='text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-4'>
            Agilit<span className='text-agilite-red'>-e</span> Modules
          </h2>
          <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
            A comprehensive suite of modules designed to handle every aspect of your integration needs. Each module is
