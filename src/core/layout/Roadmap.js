...
import { faRocket, faClock, faCheck, faSpinner } from '@fortawesome/free-solid-svg-icons'
  ...
  const roadmap = [
    {
      ...
      description:
        'Implementation of advanced security measures including enhanced encryption and improved access controls.',
      timeline: 'Q1 2024'
    },
    {
      status: 'in-progress',
      ...
      description:
        'New dashboard providing detailed insights into system performance, usage patterns, and integration metrics.',
      timeline: 'Q2 2024'
    },
    {
      status: 'planned',
      ...
      description:
        'Intelligent system that helps users create and optimize integrations using natural language processing.',
      timeline: 'Q3 2024'
    },
    {
      status: 'planned',
      ...
      description:
        'Expanded API functionality with support for GraphQL, WebSocket connections, and real-time data streaming.',
      timeline: 'Q4 2024'
    },
    {
      status: 'planned',
      ...
      description:
        'Additional Node-RED nodes and improved integration capabilities for more complex workflow scenarios.',
      timeline: 'Q1 2025'
    },
    {
      status: 'planned',
      ...
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
            Our vision for the future of Agilit<span className='text-agilite-red'>-e</span>. We're constantly working on
            new features and improvements to make your integration experience even better.
          </p>
        </div>
