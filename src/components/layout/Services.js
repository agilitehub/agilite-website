      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Agilit<span className="text-agilite-red">-e</span> provides a comprehensive suite of integration services designed by developers, for developers. Our platform combines power and simplicity to solve your most complex integration challenges.
          </p>
          <a 
            href="#modules" 
